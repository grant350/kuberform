...
(function (global, factory) {
   true ? factory(__webpack_require__(6553)) : 0;
...
var aa = __webpack_require__(1080),
  ca = __webpack_require__(1838);
function p(a) {
...
var m = __webpack_require__(9711);
if (true) {
...
if (true) {
  ...
  checkDCE();
  module.exports = __webpack_require__(3483);
} else {}
...
var f = __webpack_require__(1080),
...
if (true) {
  module.exports = __webpack_require__(8962);
} else {}
...
if (true) {
  module.exports = __webpack_require__(9673);
} else {}
...
if (true) {
  module.exports = __webpack_require__(6477);
} else {}
...
/* harmony export */ });
/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8227);
/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1878);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*,*:after,*:before{box-sizing:border-box}body{font-family:\"DM Sans\",sans-serif;line-height:1.5;background-color:#f1f3fb;padding:0 2rem}img{max-width:100%;display:block}input{appearance:none;border-radius:0}.card{margin:2rem auto;display:flex;flex-direction:column;width:100%;max-width:425px;background-color:#fff;border-radius:10px;box-shadow:0 10px 20px 0 rgba(153,153,153,.25);padding:.75rem}.card-image{border-radius:8px;overflow:hidden;padding-bottom:65%;background-image:url(\"https://assets.codepen.io/285131/coffee_1.jpg\");background-repeat:no-repeat;background-size:150%;background-position:0 5%;position:relative}.card-heading{position:absolute;left:10%;top:15%;right:10%;font-size:1.75rem;font-weight:700;color:#735400;line-height:1.222}.card-heading small{display:block;font-size:.75em;font-weight:400;margin-top:.25em}.card-form{padding:2rem 1rem 0}.input{display:flex;flex-direction:column-reverse;position:relative;padding-top:1.5rem}.input+.input{margin-top:1.5rem}.input-label{color:#8597a3;position:absolute;top:1.5rem;transition:.25s ease}.input-field{border:0;z-index:1;background-color:rgba(0,0,0,0);border-bottom:2px solid #eee;font:inherit;font-size:1.125rem;padding:.25rem 0}.input-field:focus,.input-field:valid{outline:0;border-bottom-color:#6658d3}.input-field:focus+.input-label,.input-field:valid+.input-label{color:#6658d3;transform:translateY(-1.5rem)}.action{margin-top:2rem}.action-button{font:inherit;font-size:1.25rem;padding:1em;width:100%;font-weight:500;background-color:#6658d3;border-radius:6px;color:#fff;border:0}.action-button:focus{outline:0}.card-info{padding:1rem 1rem;text-align:center;font-size:.875rem;color:#8597a3}.card-info a{display:block;color:#6658d3;text-decoration:none}", ""]);
// Exports
...
var react = __webpack_require__(1080);
// EXTERNAL MODULE: ./node_modules/react-dom/client.js
var client = __webpack_require__(1587);
...
;// CONCATENATED MODULE: ./kuberform/FormError.js
...
function _createSuper(Derived) { var hasNativeReflectConstruct = FormError_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function FormError_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
var FormError = /*#__PURE__*/function (_Error) {
  _inherits(FormError, _Error);
  var _super = _createSuper(FormError);
  function FormError(message) {
    var _this;
    classCallCheck_classCallCheck(this, FormError);
    _this = _super.call(this, message);
    _this.name = 'FormError';
    return _this;
  }
  return createClass_createClass(FormError);
}( /*#__PURE__*/_wrapNativeSuper(Error));
/* harmony default export */ const kuberform_FormError = (FormError);
;// CONCATENATED MODULE: ./kuberform/ErrorHandler.js
  ...
  createClass_createClass(ErrorHandler, [{
    ...
    value: function formGroupHandler(control) {
      if (control.props.groupName === undefined || typeof control.props.groupName !== 'string') {
        throw new kuberform_FormError("groupName prop not found on '<FormGroup>' component");
      }
      if (control.props.children === undefined) {
        throw new kuberform_FormError('FormGroup component needs children with one instance of <FormGroup>, <FormArray>, <FormControl>');
      }
    }
    ...
    value: function checkControlProps(control) {
      if (control.constructor.name === 'FormControl') {
        if (control.props.controlName === undefined || typeof control.props.controlName !== 'string') {
          throw new kuberform_FormError("controlName prop not found on '<FormControl>' component");
        }
        if (control.props.updateOn !== undefined) {
          try {
            if (['change', 'blur'].includes(control.props.updateOn.toLowerCase()) === false) {
              throw new kuberform_FormError('updateOn prop must be either "change" or "blur" ');
            }
          } catch (_unused) {
            throw new kuberform_FormError('updateOn prop must be either "change" or "blur" ');
          }
        ...
        if (control.props.validators) {
          if (Array.isArray(control.props.validators) === false) {
            throw new kuberform_FormError('validators prop on "<FormControl>" must be of type Array');
          }
          control.props.validators.forEach(function (fn) {
            if (fn instanceof Function === false) {
              throw new kuberform_FormError('validators must be a function with parameters control and observable');
            }
          });
        }
        if (control.props.children === undefined) {
          throw new kuberform_FormError('FormControl needs children');
        }
      }
    }
  }]);
...
/* harmony default export */ const kuberform_ErrorHandler = (ErrorHandler);
;// CONCATENATED MODULE: ./kuberform/AbstractControl.js
...
function AbstractControl_createSuper(Derived) { var hasNativeReflectConstruct = AbstractControl_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function AbstractControl_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var AbstractControl = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = AbstractControl_createSuper(AbstractControl);
  function AbstractControl(props) {
    var _this;
    classCallCheck_classCallCheck(this, AbstractControl);
    _this = _super.call(this, props);
    // eslint-disable-next-line react/no-unused-class-component-methods
    _this.errorHandler = new kuberform_ErrorHandler(_assertThisInitialized(_this));
  ...
  // eslint-disable-next-line react/no-unused-class-component-methods
  createClass_createClass(AbstractControl, [{
    key: "getErrors",
...
;// CONCATENATED MODULE: ./kuberform/FormGroup.js
...
function FormGroup_createSuper(Derived) { var hasNativeReflectConstruct = FormGroup_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function FormGroup_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var FormGroup = /*#__PURE__*/function (_AbstractControl) {
  ...
  var _super = FormGroup_createSuper(FormGroup);
  function FormGroup(props) {
    var _this;
    classCallCheck_classCallCheck(this, FormGroup);
    _this = _super.call(this, props);
    _this.state = {
      value: {},
      status: 'VALID',
  ...
  createClass_createClass(FormGroup, [{
    key: "recurseDom",
          ...
          if (child.props.controlName) {
            var NEWREF = function NEWREF(element) {
              if (controls[child.props.controlName]) {
                throw new kuberform_FormError('duplicate controlName');
              }
            ...
            if (Object.prototype.hasOwnProperty.call(child.props.children, 'type') === false) {
              return /*#__PURE__*/react.cloneElement(child, {
                ...
                children: /*#__PURE__*/(0,jsx_runtime.jsx)(child.props.children, {})
              });
            }
            return /*#__PURE__*/react.cloneElement(child, {
              ref: NEWREF,
          ...
          if (child.props.groupName) {
            var _NEWREF = function _NEWREF(element) {
              if (controls[child.props.groupName]) {
                throw new kuberform_FormError('duplicate groupName');
              }
              // eslint-disable-next-line no-param-reassign
          ...
          if (child.props.arrayName) {
            var _NEWREF2 = function _NEWREF2(element) {
              if (controls[child.props.arrayName]) {
                throw new kuberform_FormError('duplicate arrayName');
              }
              // eslint-disable-next-line no-param-reassign
    ...
    value: function render() {
      ...
      return (
        ...
        (0,jsx_runtime.jsx)("div", {
          className: "formGroup",
          sx: this.props.sx,
          children: react.Children.map(this.clonedChildren, function (child) {
  ...
  return FormGroup;
}(kuberform_AbstractControl);
/* harmony default export */ const kuberform_FormGroup = (FormGroup);
;// CONCATENATED MODULE: ./kuberform/FormArray.js
...
function FormArray_createSuper(Derived) { var hasNativeReflectConstruct = FormArray_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function FormArray_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var FormArray = /*#__PURE__*/function (_AbstractControl) {
  ...
  var _super = FormArray_createSuper(FormArray);
  function FormArray(props) {
    var _this;
    classCallCheck_classCallCheck(this, FormArray);
    _this = _super.call(this, props);
    _this.state = {
      value: [],
      status: 'VALID',
  ...
  createClass_createClass(FormArray, [{
    key: "recurseDom",
    value: function recurseDom(children, controls, depth) {
      var _this2 = this;
...
/* harmony default export */ const kuberform_FormArray = (FormArray);
;// CONCATENATED MODULE: ./kuberform/FormControl.js
...
function FormControl_createSuper(Derived) { var hasNativeReflectConstruct = FormControl_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function FormControl_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var FormControl = /*#__PURE__*/function (_AbstractControl) {
  ...
  var _super = FormControl_createSuper(FormControl);
  function FormControl(props) {
    var _this;
    classCallCheck_classCallCheck(this, FormControl);
    _this = _super.call(this, props);
    _this.state = {
      status: 'VALID',
  ...
  createClass_createClass(FormControl, [{
...
/* harmony default export */ const kuberform_FormControl = (FormControl);
// EXTERNAL MODULE: ./node_modules/moment/moment.js
var moment_moment = __webpack_require__(6553);
;// CONCATENATED MODULE: ./kuberform/validators.js



var Validators = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  function Validators() {
...
/* harmony default export */ const validators = ((/* unused pure expression or super */ null && (Validators)));
;// CONCATENATED MODULE: ./kuberform/index.js
...
var injectStylesIntoStyleTag = __webpack_require__(1243);
var injectStylesIntoStyleTag_default = /*#__PURE__*/__webpack_require__.n(injectStylesIntoStyleTag);
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/styleDomAPI.js
var styleDomAPI = __webpack_require__(1833);
var styleDomAPI_default = /*#__PURE__*/__webpack_require__.n(styleDomAPI);
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/insertBySelector.js
var insertBySelector = __webpack_require__(8944);
var insertBySelector_default = /*#__PURE__*/__webpack_require__.n(insertBySelector);
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js
var setAttributesWithoutAttributes = __webpack_require__(2521);
var setAttributesWithoutAttributes_default = /*#__PURE__*/__webpack_require__.n(setAttributesWithoutAttributes);
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/insertStyleElement.js
var insertStyleElement = __webpack_require__(1309);
var insertStyleElement_default = /*#__PURE__*/__webpack_require__.n(insertStyleElement);
// EXTERNAL MODULE: ./node_modules/style-loader/dist/runtime/styleTagTransform.js
var styleTagTransform = __webpack_require__(8153);
var styleTagTransform_default = /*#__PURE__*/__webpack_require__.n(styleTagTransform);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./app/FormExample1/index.scss
var FormExample1 = __webpack_require__(9821);
;// CONCATENATED MODULE: ./app/FormExample1/index.scss
...
var update = injectStylesIntoStyleTag_default()(FormExample1/* default */.Z, options);




       /* harmony default export */ const app_FormExample1 = (FormExample1/* default */.Z && FormExample1/* default.locals */.Z.locals ? FormExample1/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./app/FormExample1/index.js
...
function FormExample1_createSuper(Derived) { var hasNativeReflectConstruct = FormExample1_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function FormExample1_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }





var FormExample1_FormExample1 = /*#__PURE__*/function (_React$Component) {
  _inherits(FormExample1, _React$Component);
  var _super = FormExample1_createSuper(FormExample1);
  function FormExample1(props) {
    var _this;
    classCallCheck_classCallCheck(this, FormExample1);
    _this = _super.call(this, props);
    _this.ref = /*#__PURE__*/react.createRef();
    _this.submit = _this.submit.bind(_assertThisInitialized(_this));
    return _this;
  }
  createClass_createClass(FormExample1, [{
    key: "submit",
    ...
    */
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/(0,jsx_runtime.jsx)(kuberform_FormGroup, {
        ref: this.ref,
        groupName: "login",
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)("h2", {
                ...
                children: ["Get started", /*#__PURE__*/(0,jsx_runtime.jsx)("small", {
                  children: "Let us create your account"
                })]
              })
            }), /*#__PURE__*/(0,jsx_runtime.jsxs)("form", {
              className: "card-form",
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)(kuberform_FormControl, {
                ...
                children: function children(props) {
                  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                    ...
                    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("label", {
                      ...
                      children: ["Full name", /*#__PURE__*/(0,jsx_runtime.jsx)("input", {
                        type: "text",
              ...
              }), /*#__PURE__*/(0,jsx_runtime.jsx)(kuberform_FormControl, {
                controlName: "email",
                ...
                children: function children(props) {
                  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                    ...
                    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("label", {
                      className: "input-label",
                      children: ["Email", /*#__PURE__*/(0,jsx_runtime.jsx)("input", {
                        type: "text",
                        className: "input-field",
                        defaultValue: props.value,
                        required: true
                ...
                children: function children() {
                  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                    ...
                    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("label", {
                      className: "input-label",
                      children: ["Password", /*#__PURE__*/(0,jsx_runtime.jsx)("input", {
                        type: "password",
                        className: "input-field",
                        required: true
                      })]
              ...
              }), /*#__PURE__*/(0,jsx_runtime.jsx)(kuberform_FormArray, {
                arrayName: "nestedArray",
                children: /*#__PURE__*/(0,jsx_runtime.jsx)(kuberform_FormControl, {
                  controlName: "secretid",
                  children: function children() {
                    return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                      className: "input",
                      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("label", {
                        className: "input-label",
                        children: ["secretid", /*#__PURE__*/(0,jsx_runtime.jsx)("input", {
                          type: "text",
                          className: "input-field",
                          required: true
                        })]
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)("p", {
                children: ["By signing up you are agreeing to our", /*#__PURE__*/(0,jsx_runtime.jsx)("a", {
                  href: "/",
...
/* harmony default export */ const app_FormExample1_0 = (FormExample1_FormExample1);
...
var App = /*#__PURE__*/function (_React$Component) {
  ...
  createClass_createClass(App, [{
    ...
    value: function render() {
      return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "form-page",
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(app_FormExample1_0, {})
      });
    }
  }]);
  return App;
...
function index_createSuper(Derived) { var hasNativeReflectConstruct = index_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
...
var Root = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = index_createSuper(Root);
  function Root() {
    classCallCheck_classCallCheck(this, Root);
    return _super.apply(this, arguments);
  }
  createClass_createClass(Root, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
  ...
  return Root;
}(react.Component); // eslint-disable-next-line no-undef
var ROOT = client/* createRoot */.s(document.getElementById('app'));
ROOT.render( /*#__PURE__*/(0,jsx_runtime.jsx)(Root, {}));
})();
